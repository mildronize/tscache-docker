...
docker cp ./tests/data/$import_file $container_id:/opt/opentsdb/opentsdb-2.3.0/data/$import_file && docker exec -i $container_id $tsdb_cli_path import ./data/$import_file
